...
const th: MessageSchema = {
    ...
    hero: {
        status: 'ออนไลน์ · UTC + 7',
        greeting: 'สวัสดีครับ ผมชื่อ Jhom',
        role: 'ผมเป็น {role}',
    },
    about: {
        whoami: 'Hi there!👋{br}ผมคือ {name}',
        from: 'ผมเป็น {role}{br} จาก {country}',
        country: 'ประเทศเมียนมา',
        based: 'ปัจจุบันผมอาศัยอยู่ที่ {city}',
        city: 'กรุงเทพฯ ประเทศไทย',
        specializing: 'ผมมีความเชี่ยวชาญด้าน{br}{field}',
