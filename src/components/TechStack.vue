        ...
        <div v-if="activeSection == 'tech-stack' || isMobile" class="tech-stack">
            ...
            <div class="tech-stack-right">
                <div class="tech-stack-grid">
                    <!-- Placeholder: start of row 1 -->
                    <div class="tech-stack-grid-item grid-18" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                    ...
                    <!-- Placeholder: end of row 1 -->
                    <div class="tech-stack-grid-item grid-15" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                    <!-- Placeholder: start of row 2 -->
                    <div class="tech-stack-grid-item grid-19" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                    ...
                    <!-- Placeholder: end of row 2 -->
                    <div class="tech-stack-grid-item grid-16" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                    <!-- Placeholder: start of row 3 -->
                    <div class="tech-stack-grid-item grid-20" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                    ...
                    <!-- Placeholder: end of row 3 -->
                    <div class="tech-stack-grid-item grid-17" :class="{'reduced-opacity': hoverOnExp.hoverStart}"></div>
                </div>
