        ...
        <div v-if="activeSection == 'tech-stack'" class="tech-stack">
            ...
            <div class="tech-stack-right">
                <div class="tech-stack-grid">
                    ...
                    <div class="tech-stack-grid-item grid-13" :class="{'used-googlecloud': hasUsed.googlecloud, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.googlecloud }" @mouseenter="mouseEnterOnLogo('googlecloud')" @mouseleave="mouseLeaveOnLogo('googlecloud')">
                        <!-- Google Cloud -->
