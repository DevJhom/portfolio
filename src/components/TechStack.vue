...
const mouseEnterOnExp = (experience: string) => {
    ...
    if (experience == 'internship') {
        ...
        hasUsed.csharp = true;
        hasUsed.cplusplus = true;
        hasUsed.nodejs = true;
        hasUsed.firebase = true;
        hasUsed.sql = true;
    }
...
const mouseLeaveOnExp = (experience: string) => {
    ...
    if (experience == 'internship') {
        ...
        hasUsed.cplusplus = false;
        hasUsed.nodejs = false;
        hasUsed.firebase = false;
        hasUsed.sql = false;
    }
    ...
    <div class="tech-stack">
        ...
        <div class="tech-stack-right">
            <div class="tech-stack-grid">
                <div class="tech-stack-grid-item grid-2" :class="{'used-vue': hasUsed.vue, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.vue }" @mouseenter="mouseEnterOnLogo('vue')" @mouseleave="mouseLeaveOnLogo('vue')">
                    <!-- Vue -->
                ...
                <div class="tech-stack-grid-item grid-3" :class="{'used-react': hasUsed.react, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.react }" @mouseenter="mouseEnterOnLogo('react')" @mouseleave="mouseLeaveOnLogo('react')">
                    <!-- React -->
                ...
                <div class="tech-stack-grid-item grid-4" :class="{'used-typescript': hasUsed.typescript, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.typescript }" @mouseenter="mouseEnterOnLogo('typescript')" @mouseleave="mouseLeaveOnLogo('typescript')">
                    <!-- Typescript -->
                ...
                <div class="tech-stack-grid-item grid-5" :class="{'used-scss': hasUsed.scss, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.scss }" @mouseenter="mouseEnterOnLogo('scss')" @mouseleave="mouseLeaveOnLogo('scss')">
                    <!-- SCSS -->
                ...
                <div class="tech-stack-grid-item grid-6" :class="{'used-csharp': hasUsed.csharp, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.csharp }" @mouseenter="mouseEnterOnLogo('csharp')" @mouseleave="mouseLeaveOnLogo('csharp')">
                    <!-- C# -->
                ...
                <div class="tech-stack-grid-item grid-7" :class="{'used-cplusplus': hasUsed.cplusplus, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.cplusplus }" @mouseenter="mouseEnterOnLogo('cplusplus')" @mouseleave="mouseLeaveOnLogo('cplusplus')">
                    <!-- C++ -->
                ...
                <div class="tech-stack-grid-item grid-8" :class="{'used-nodejs': hasUsed.nodejs, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.nodejs }" @mouseenter="mouseEnterOnLogo('nodejs')" @mouseleave="mouseLeaveOnLogo('nodejs')">
                    <!-- Node.js -->
                ...
                <div class="tech-stack-grid-item grid-9" :class="{'used-firebase': hasUsed.firebase, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.firebase }" @mouseenter="mouseEnterOnLogo('firebase')" @mouseleave="mouseLeaveOnLogo('firebase')">
                    <!-- Firebase -->
                ...
                <div class="tech-stack-grid-item grid-10" :class="{'used-sql': hasUsed.sql, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.sql }" @mouseenter="mouseEnterOnLogo('sql')" @mouseleave="mouseLeaveOnLogo('sql')">
                    <!-- SQL -->
                ...
                <div class="tech-stack-grid-item grid-11" :class="{'used-git': hasUsed.git, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.git }" @mouseenter="mouseEnterOnLogo('git')" @mouseleave="mouseLeaveOnLogo('git')">
                    <!-- Git -->
                ...
                <div class="tech-stack-grid-item grid-12" :class="{'used-docker': hasUsed.docker, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.docker }" @mouseenter="mouseEnterOnLogo('docker')" @mouseleave="mouseLeaveOnLogo('docker')">
                    <!-- Docker -->
                    <span v-if="isHover.docker">Docker</span>
                    <svg v-else viewBox="0 0 128 128" width="35" height="35">
                ...
                <div class="tech-stack-grid-item grid-13" :class="{'used-googlecloud': hasUsed.googlecloud, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.docker }" @mouseenter="mouseEnterOnLogo('googlecloud')" @mouseleave="mouseLeaveOnLogo('googlecloud')">
                    <!-- Google Cloud -->
                ...
                <div class="tech-stack-grid-item grid-14" :class="{'used-neovim': hasUsed.neovim, 'reduced-opacity': hasUsed.hoverStart && !hasUsed.neovim }" @mouseenter="mouseEnterOnLogo('neovim')" @mouseleave="mouseLeaveOnLogo('neovim')">
                    <!-- NeoVim -->
                    <span v-if="isHover.neovim">NeoVim</span>
                    <svg v-else viewBox="0 0 128 128" width="24" height="24">
                        <defs> <linearGradient id="a" x1="0.5" x2="0.5" y1="0" y2="1" gradientTransform="matrix(32.95703 0 0 154.72266 .426 .426)" gradientUnits="userSpaceOnUse"> <stop offset="0" stop-color="#16b0ed" stop-opacity=".8"></stop> <stop offset="1" stop-color="#0f59b2" stop-opacity=".835294"></stop> </linearGradient> <linearGradient id="b" x1="0.5" x2="0.5" y1="0" y2="1" gradientTransform="matrix(-33.59375 0 0 154.72266 128 .426)" gradientUnits="userSpaceOnUse"> <stop offset="0" stop-color="#7db643"></stop> <stop offset="1" stop-color="#367533"></stop> </linearGradient> <linearGradient id="c" x1="0.5" x2="0.5" y1="0" y2="1" gradientTransform="matrix(109.71484 0 0 154.72656 9.355 .637)" gradientUnits="userSpaceOnUse"> <stop offset="0" stop-color="#88c649" stop-opacity=".8"></stop> <stop offset="1" stop-color="#439240" stop-opacity=".839216"></stop> </linearGradient> </defs> <g fill-rule="evenodd"> <path fill="url(#a)" d="M.426 33.703 33.383.426v154.722L.426 122.258Zm0 0" transform="translate(10.95 -.352) scale(.82614)"></path> <path fill="url(#b)" d="M127.773 34 94.406.426l.676 154.722L128 122.254Zm0 0" transform="translate(10.95 -.352) scale(.82614)"></path> <path fill="url(#c)" d="m33.379.637 85.691 130.75-23.98 23.976L9.355 24.903Zm0 0" transform="translate(10.95 -.352) scale(.82614)"></path> <path fill-opacity="0.129412" d="m38.53 50.01-.04 4.244-21.743-32.18 2.014-2.06zm0 0"></path> </g> 
                    </svg>
                </div>
            </div>
