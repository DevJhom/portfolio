    ...
    <div class="tech-stack">
        ...
        <div class="tech-stack-right">
            <div class="tech-stack-grid">
                <div class="tech-stack-grid-item grid-2">
                    <!-- Vue -->
                ...
                <div class="tech-stack-grid-item grid-3">
                    <!-- React -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-4">
                    <!-- Typescript -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-5">
                    <!-- SCSS -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-6">
                    <!-- C# -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-7">
                    <!-- C++ -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-8">
                    <!-- Node.js -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-9">
                    <!-- Firebase -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-10">
                    <!-- SQL -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
                ...
                <div class="tech-stack-grid-item grid-11">
                    <!-- Git -->
                    <svg viewBox="0 0 128 128" width="30" height="30">
               ...
               <div class="tech-stack-grid-item grid-12">
                    <!-- Docker -->
                ...
                <div class="tech-stack-grid-item grid-13">
                    <!-- Google Cloud -->
                ...
                <div class="tech-stack-grid-item grid-14">
                    <!-- NeoVim -->
