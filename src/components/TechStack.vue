    ...
    <div class="tech-stack">
        ...
        <div class="tech-stack-right">
            <div class="tech-stack-grid">
                ...
                <div class="tech-stack-grid-item grid-5" @mouseenter="mouseEnter('scss')" @mouseleave="mouseLeave('scss')">
                    <!-- SCSS -->
                ...
                <div class="tech-stack-grid-item grid-6" @mouseenter="mouseEnter('csharp')" @mouseleave="mouseLeave('csharp')">
                    <!-- C# -->
                ...
                <div class="tech-stack-grid-item grid-7" @mouseenter="mouseEnter('cplusplus')" @mouseleave="mouseLeave('cplusplus')">
                    <!-- C++ -->
                ...
                <div class="tech-stack-grid-item grid-8" @mouseenter="mouseEnter('nodejs')" @mouseleave="mouseLeave('nodejs')">
                    <!-- Node.js -->
                ...
                <div class="tech-stack-grid-item grid-9" @mouseenter="mouseEnter('firebase')" @mouseleave="mouseLeave('firebase')">
                    <!-- Firebase -->
                ...
                <div class="tech-stack-grid-item grid-10" @mouseenter="mouseEnter('sql')" @mouseleave="mouseLeave('sql')">
                    <!-- SQL -->
                ...
                <div class="tech-stack-grid-item grid-11" @mouseenter="mouseEnter('git')" @mouseleave="mouseLeave('git')">
                    <!-- Git -->
                ...
                <div class="tech-stack-grid-item grid-12" @mouseenter="mouseEnter('docker')" @mouseleave="mouseLeave('docker')">
                    <!-- Docker -->
                ...
                <div class="tech-stack-grid-item grid-14" @mouseenter="mouseEnter('neovim')" @mouseleave="mouseLeave('neovim')">
                    <!-- NeoVim -->
