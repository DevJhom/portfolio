    ...
    <div class="tech-stack">
        ...
        <div class="tech-stack-right">
            <div class="tech-stack-grid">
                <div class="tech-stack-grid-item grid-2" :class="{'used-vue': hasUsed.vue }" @mouseenter="mouseEnterOnLogo('vue')" @mouseleave="mouseLeaveOnLogo('vue')">
                    <!-- Vue -->
                ...
                <div class="tech-stack-grid-item grid-3" :class="{'used-react': hasUsed.react }" @mouseenter="mouseEnterOnLogo('react')" @mouseleave="mouseLeaveOnLogo('react')">
                    <!-- React -->
                ...
                <div class="tech-stack-grid-item grid-4" :class="{'used-typescript': hasUsed.typescript }" @mouseenter="mouseEnterOnLogo('typescript')" @mouseleave="mouseLeaveOnLogo('typescript')">
                    <!-- Typescript -->
                ...
                <div class="tech-stack-grid-item grid-5" :class="{'used-scss': hasUsed.scss }" @mouseenter="mouseEnterOnLogo('scss')" @mouseleave="mouseLeaveOnLogo('scss')">
                    <!-- SCSS -->
                ...
                <div class="tech-stack-grid-item grid-6" :class="{'used-csharp': hasUsed.csharp }" @mouseenter="mouseEnterOnLogo('csharp')" @mouseleave="mouseLeaveOnLogo('csharp')">
                    <!-- C# -->
                ...
                <div class="tech-stack-grid-item grid-7" :class="{'used-cplusplus': hasUsed.cplusplus }" @mouseenter="mouseEnterOnLogo('cplusplus')" @mouseleave="mouseLeaveOnLogo('cplusplus')">
                    <!-- C++ -->
                ...
                <div class="tech-stack-grid-item grid-8" :class="{'used-nodejs': hasUsed.nodejs }" @mouseenter="mouseEnterOnLogo('nodejs')" @mouseleave="mouseLeaveOnLogo('nodejs')">
                    <!-- Node.js -->
                ...
                <div class="tech-stack-grid-item grid-9" :class="{'used-firebase': hasUsed.firebase }" @mouseenter="mouseEnterOnLogo('firebase')" @mouseleave="mouseLeaveOnLogo('firebase')">
                    <!-- Firebase -->
                ...
                <div class="tech-stack-grid-item grid-10" :class="{'used-sql': hasUsed.sql}" @mouseenter="mouseEnterOnLogo('sql')" @mouseleave="mouseLeaveOnLogo('sql')">
                    <!-- SQL -->
                ...
                <div class="tech-stack-grid-item grid-11" :class="{'used-git': hasUsed.git}" @mouseenter="mouseEnterOnLogo('git')" @mouseleave="mouseLeaveOnLogo('git')">
                    <!-- Git -->
                ...
                <div class="tech-stack-grid-item grid-12" :class="{'used-docker': hasUsed.docker}" @mouseenter="mouseEnterOnLogo('docker')" @mouseleave="mouseLeaveOnLogo('docker')">
                    <!-- Docker -->
                ...
                <div class="tech-stack-grid-item grid-13" :class="{'used-googlecloud': hasUsed.googlecloud}" @mouseenter="mouseEnterOnLogo('googlecloud')" @mouseleave="mouseLeaveOnLogo('googlecloud')">
                    <!-- Google Cloud -->
                ...
                <div class="tech-stack-grid-item grid-14" :class="{'used-neovim': hasUsed.neovim}" @mouseenter="mouseEnterOnLogo('neovim')" @mouseleave="mouseLeaveOnLogo('neovim')">
                    <!-- NeoVim -->
