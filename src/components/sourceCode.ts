...
export const sourceLines: Token[][] = [
    ...
    [['            '], ['<', 'punc'], ['span', 'tag'], [' class', 'attr'], ['=', 'punc'], ['"logo-flip"', 'str'], ['>', 'punc']],
    [['                '], ['<', 'punc'], ['span', 'tag'], [' class', 'attr'], ['=', 'punc'], ['"logo-flip-inner"', 'str'], ['>', 'punc']],
    [['                    '], ['<', 'punc'], ['img', 'tag'], [' src', 'attr'], ['=', 'punc'], ['"/letter-j.png"', 'str'], [' alt', 'attr'], ['=', 'punc'], ['"DevJhom Logo"', 'str'], [' class', 'attr'], ['=', 'punc'], ['"logo-face logo-img"', 'str'], [' height', 'attr'], ['=', 'punc'], ['"35"', 'str'], [' width', 'attr'], ['=', 'punc'], ['"35"', 'str'], ['>', 'punc']],
    [['                    '], ['<', 'punc'], ['span', 'tag'], [' class', 'attr'], ['=', 'punc'], ['"logo-face logo-photo"', 'str'], [' aria-hidden', 'attr'], ['=', 'punc'], ['"true"', 'str'], ['></', 'punc'], ['span', 'tag'], ['>', 'punc']],
    [['                '], ['</', 'punc'], ['span', 'tag'], ['>', 'punc']],
    [['            '], ['</', 'punc'], ['span', 'tag'], ['>', 'punc']],
    [['            '], ['<', 'punc'], ['h4', 'tag'], [' class', 'attr'], ['=', 'punc'], ['"logo-text"', 'str'], ['>', 'punc'], ['DevJhom'], ['</', 'punc'], ['h4', 'tag'], ['>', 'punc']],
    [['        '], ['</', 'punc'], ['a', 'tag'], ['>', 'punc']],
    ...
    [['        '], ['<', 'punc'], ['h4', 'tag'], ['>', 'punc'], ['Resume'], ['</', 'punc'], ['h4', 'tag'], ['>', 'punc']],
    [['    '], ['</', 'punc'], ['div', 'tag'], ['>', 'punc']],
    [['    '], ['<!-- HOME -->', 'cmt']],
